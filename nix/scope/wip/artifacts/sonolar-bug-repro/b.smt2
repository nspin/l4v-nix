...
(assert (= query_load-word32Mem_initb #x00000000))
(assert (= path_cond_to_19_ASM true))
(assert (= cond_at_13_4=1 true))
(assert (= (load-word8 Mem_after_12_4=2 q___ptr_to_unsigned_char_v_after_7_4=2) #x00))
(assert (= query_load-word32Mem_after.1 #x00000000))
(assert (= path_cond_to_24_17=4_ASM true))
(assert (= (load-word32 Mem_init (bvand ptr_dst___ptr_to_void_v_init #xfffffffd)) #x00000000))
(assert (= (rodata Mem_init) true))
(assert (= ptr #xe0004414))
(assert (= path_cond_to_13_4=2_C true))
(assert (= r21_init #x00000000))
(assert (= (load-word8 mem_after_24_17=1 (bvadd r1_after_22_17=1 #x00000001)) #x00))
(assert (= path_cond_to_24_17=2_ASM true))
(assert (= r17_init #x00000000))
(assert (= cond_at_13_4=4 false))
(assert (= r15_init #x00000000))
(assert (= r0_init #x7001b561))
(assert (= (load-word8 mem_init (bvadd r1_after_31 #x00000001)) #x00))
(assert (= n_after_26 true))
(assert (= query_load-word32mem_after.1 #x00000000))
(assert (= r2_init #xfffffffe))
(assert (= r31_init #x00000000))
(assert (= clock_init #x0000000000000000))
(assert (= path_cond_to_22_17=3_ASM true))
(assert (= r16_init #x00000000))
(assert (= p___ptr_to_unsigned_char_v_after_9_4=3 #x7001b564))
(assert (= p___ptr_to_unsigned_char_v_after_9_4=1 #x7001b562))
(assert (= cond_at_13_4=3 false))
(assert (= cond_at_13_4=2 false))
(assert (= query_load-word8Mem_initpt #x00))
(assert (= (mem-eq mem_init Mem_init) true))
(assert (= ret_addr_input_init #x7001b561))
(assert (= query_load-word8mem_after_.1 #x00))
(assert (= r29_init #x00000000))
(assert (= query_load-word8mem_after_.2 #x00))
(assert (= path_cond_to_15_C true))
(assert (= query_load-word32Mem_after #x00000000))
(assert (= r27_init #x00000000))
(assert (= mode_init #x00000000))
(assert (= r19_init #x00000000))
(assert (= ptr_src___ptr_to_void_v_init #x5fff6be4))
(assert (= n___unsigned_long_v_after_11_4=2 #xfffffffc))
(assert (= n___unsigned_long_v_after_11_4=3 #xfffffffb))
(assert (= n___unsigned_long_v_after_11_4=1 #xfffffffd))
(assert (= v_after_23_17=2 false))
(assert (= r24_init #x00000000))
(assert (= v_after_23_17=3 false))
(assert (= r30_init #x00000000))
(assert (= r4_init #x00000000))
(assert (= q___ptr_to_unsigned_char_v_after_7_4=2 #x5fff6be6))
(assert (= q___ptr_to_unsigned_char_v_after_7_4=1 #x5fff6be5))
(assert (= r3_after_24_17=1 #x7001b562))
(assert (= r3_after_24_17=3 #x7001b564))
(assert (= r3_after_24_17=2 #x7001b563))
(assert (= pvalid true))
(assert (= query_load-word32mem_initb #x00000000))
(assert (= (bvadd r1_after_22_17=2 #x00000001) #x5fff6be6))
(assert (= r9_init #x00000000))
(assert (= path_cond_to_13_4=3_C false))
(assert (= (load-word32 Mem_after_12_4=1 (bvand p___ptr_to_unsigned_char_v_after_9_4=1 #xfffffffd)) #x00000000))
(assert (= v_after_23_17=1 false))
(assert (= cond_at_29 false))
(assert (= query_bvandr3_after_24_17= #x7001b560))
(assert (= r26_init #x00000000))
(assert (= (load-word32 mem_after_24_17=2 (bvand r3_after_24_17=2 #xfffffffd)) #x00000000))
(assert (= query_load-word8Mem_after_.1 #x00))
(assert (= r7_init #x00000000))
(assert (= path_cond_to_Err_4=0_1_C false))
(assert (= n___unsigned_long_v_init #xfffffffe))
(assert (= cond_at_20_17=1 true))
(assert (= cond_at_20_17=2 true))
(assert (= cond_at_20_17=3 true))
(assert (= path_cond_to_24_17=1_ASM true))
(assert (= r1_init #x5fff6be4))
(assert (= path_cond_to_12_4=2_C false))
(assert (= query_mem-eqmem_initMem_in true))
(assert (= r13_init #x00000000))
(assert (= r28_init #x00000000))
(assert (= (bvadd r1_after_22_17=1 #x00000001) #x5fff6be5))
(assert (= pvalid.9 false))
(assert (= query_bvaddr1_after_22_17=.1 #x5fff6be6))
(assert (= ptr.8 #x7001b564))
(assert (= query_bvaddr1_after_22_17=.2 #x5fff6be7))
(assert (= r11_init #x00000000))
(assert (= c_after_23_17=1 true))
(assert (= ptr.3 #x5fff6be4))
(assert (= ptr.2 #x7001b561))
(assert (= ptr.5 #x5fff6be5))
(assert (= v_init false))
(assert (= ptr.7 #x5fff6be6))
(assert (= ptr.6 #x7001b563))
(assert (= loop_4_count_after_3_4=1 #x00000001))
(assert (= loop_4_count_after_3_4=2 #x00000002))
(assert (= loop_4_count_after_3_4=3 #x00000003))
(assert (= r1_after_22_17=4 #x5fff6be7))
(assert (= cond_at_20_17=4 true))
(assert (= pvalid.6 false))
(assert (= q___ptr_to_unsigned_char_v_after_7_4=3 #x5fff6be7))
(assert (= query_load-word32mem_after #x00000000))
(assert (= (load-word8 mem_after_24_17=2 (bvadd r1_after_22_17=2 #x00000001)) #x00))
(assert (= r22_init #x00000000))
(assert (= query_bvandp___ptr_to_unsi.1 #x7001b561))
(assert (= (bvand r3_after_24_17=1 #xfffffffd) #x7001b560))
(assert (= query_bvandr3_after_24_17=.1 #x7001b561))
(assert (= query_bvandp___ptr_to_unsi #x7001b560))
(assert (= r6_init #x00000000))
(assert (= path_cond_to_22_17=2_ASM true))
(assert (= path_cond_to_25_17=1_ASM true))
(assert (= r14_init #x00000000))
(assert (= pvalid.3 true))
(assert (= path_cond_to_22_17=1_ASM true))
(assert (= r20_init #x00000000))
(assert (= pvalid.8 false))
(assert (= n_after_23_17=1 false))
(assert (= n_after_23_17=2 false))
(assert (= n_after_23_17=3 false))
(assert (= pvalid.4 false))
(assert (= pvalid.5 false))
(assert (= query_bvandptr_dst___ptr_t #x7001b561))
(assert (= pvalid.7 false))
(assert (= r1_after_22_17=1 #x5fff6be4))
(assert (= pvalid.1 true))
(assert (= pvalid.2 true))
(assert (= r1_after_22_17=2 #x5fff6be5))
(assert (= r25_init #x00000000))
(assert (= (bvand r0_init #xfffffffd) #x7001b561))
(assert (= path_cond_to_24_17=3_ASM true))
(assert (= path_cond_to_25_17=2_ASM true))
(assert (= path_cond_to_12_4=4_C false))
(assert (= r23_init #x00000000))
(assert (= r3_init #x00000000))
(assert (= r1_after_22_17=3 #x5fff6be6))
(assert (= path_cond_to_12_4=3_C false))
(assert (= path_cond_to_13_4=1_C true))
(assert (= z_init false))
(assert (= rodata-witness-val #x00000000))
(assert (= ptr.9 #x5fff6be7))
(assert (= (load-word32 Mem_after_12_4=2 (bvand p___ptr_to_unsigned_char_v_after_9_4=2 #xfffffffd)) #x00000000))
(assert (= (bvadd r1_after_22_17=3 #x00000001) #x5fff6be7))
(assert (= c_after_26 true))
(assert (= ptr_dst___ptr_to_void_v_init #x7001b561))
(assert (= path_cond_to_26_ASM true))
(assert (= path_cond_to_13_4=4_C false))
(assert (= r12_init #x00000000))
(assert (= z_after_26 false))
(assert (= (bvand p___ptr_to_unsigned_char_v_after_9_4=1 #xfffffffd) #x7001b560))
(assert (= ptr.1 #xe001b37c))
(assert (= path_cond_to_12_4=1_C true))
(assert (= n_init false))
(assert (= cond_at_17_17=2 true))
(assert (= cond_at_17_17=3 true))
(assert (= cond_at_17_17=0 true))
(assert (= cond_at_17_17=1 true))
(assert (= c_after_23_17=3 true))
(assert (= c_after_23_17=2 true))
(assert (= (load-word8 mem_after_24_17=3 (bvadd r1_after_22_17=3 #x00000001)) #x00))
(assert (= path_cond_to_22_17=4_ASM true))
(assert (= (bvadd r1_after_31 #x00000001) #x5fff6be4))
(assert (= ptr.4 #x7001b562))
(assert (= rodata-witness #xe001b450))
(assert (= ret_init #x00000000))
(assert (= query_q___ptr_to_unsigned_.1 #x5fff6be6))
(assert (= (bvand ptr_dst___ptr_to_void_v_init #xfffffffd) #x7001b561))
(assert (= query_bvandr0_init_xffffff #x7001b561))
(assert (= query_bvaddr1_after_22_17= #x5fff6be5))
(assert (= query_q___ptr_to_unsigned_ #x5fff6be5))
(assert (= v_after_26 false))
(assert (= z_after_23_17=3 false))
(assert (= (bvand r3_after_24_17=2 #xfffffffd) #x7001b561))
(assert (= (load-word8 Mem_after_12_4=1 q___ptr_to_unsigned_char_v_after_7_4=1) #x00))
(assert (= cond_at_5_4=3 true))
(assert (= query_load-word8Mem_after_ #x00))
(assert (= c_init false))
(assert (= r5_init #x00000000))
(assert (= p___ptr_to_unsigned_char_v_after_9_4=2 #x7001b563))
(assert (= (bvand p___ptr_to_unsigned_char_v_after_9_4=2 #xfffffffd) #x7001b561))
(assert (= path_cond_to_25_17=3_ASM true))
(assert (= r18_init #x00000000))
(assert (= r12_after_22_17=4 #x00000000))
(assert (= r12_after_22_17=1 #x00000000))
(assert (= r12_after_22_17=2 #x00000000))
(assert (= r12_after_22_17=3 #x00000000))
(assert (= (load-word32 mem_init (bvand r0_init #xfffffffd)) #x00000000))
(assert (= r2_after_33 #x7001b55f))
(assert (= query_bvaddr1_after_31_x00 #x5fff6be4))
(assert (= query_load-word8mem_after_ #x00))
(assert (= (load-word32 mem_after_24_17=1 (bvand r3_after_24_17=1 #xfffffffd)) #x00000000))
(assert (= query_load-word8mem_initbv #x00))
(assert (= loop_4_count_after_6 #x00000000))
(assert (= cond_at_35_17=2 true))
(assert (= cond_at_35_17=3 true))
(assert (= r10_init #x00000000))
(assert (= cond_at_35_17=1 true))
(assert (= (load-word8 Mem_init ptr_src___ptr_to_void_v_init) #x00))
(assert (= query_rodataMem_init true))
(assert (= cond_at_5_4=4 true))
(assert (= r8_init #x00000000))
(assert (= cond_at_5_4=2 true))
(assert (= query_ptr_src___ptr_to_voi #x5fff6be4))
(assert (= z_after_23_17=1 false))
(assert (= cond_at_5_4=1 true))
(assert (= r1_after_31 #x5fff6be3))
(assert (= z_after_23_17=2 false))
(check-sat)
(get-value (query_load-word32Mem_initb path_cond_to_19_ASM query_load-word8Mem_initpt query_load-word32Mem_after.1 ptr path_cond_to_13_4=2_C r21_init path_cond_to_24_17=2_ASM r17_init cond_at_13_4=4 n___unsigned_long_v_init r0_init n_after_26 query_load-word32mem_after.1 r2_init r31_init clock_init path_cond_to_22_17=3_ASM r16_init p___ptr_to_unsigned_char_v_after_9_4=3 p___ptr_to_unsigned_char_v_after_9_4=1 cond_at_13_4=3 cond_at_13_4=2 cond_at_13_4=1 ret_addr_input_init query_load-word8mem_after_.1 r29_init query_load-word8mem_after_.2 path_cond_to_15_C query_load-word32Mem_after r27_init mode_init r19_init ptr_src___ptr_to_void_v_init n___unsigned_long_v_after_11_4=2 n___unsigned_long_v_after_11_4=3 query_bvandr3_after_24_17= v_after_23_17=2 r24_init v_after_23_17=3 r30_init r4_init q___ptr_to_unsigned_char_v_after_7_4=2 q___ptr_to_unsigned_char_v_after_7_4=1 r3_after_24_17=1 r3_after_24_17=3 r3_after_24_17=2 query_load-word8Mem_after_ path_cond_to_25_17=3_ASM path_cond_to_Err_4=0_1_C pvalid query_load-word32mem_initb r9_init path_cond_to_13_4=3_C cond_at_29 n___unsigned_long_v_after_11_4=1 query_load-word8Mem_after_.1 r7_init cond_at_20_17=4 r15_init cond_at_20_17=1 cond_at_20_17=2 cond_at_20_17=3 path_cond_to_24_17=1_ASM r1_init path_cond_to_12_4=2_C query_mem-eqmem_initMem_in r13_init r28_init pvalid.9 query_bvaddr1_after_22_17=.1 ptr.8 query_bvaddr1_after_22_17=.2 r11_init c_after_23_17=1 loop_4_count_after_3_4=1 ptr.3 c_after_23_17=2 ptr.5 v_init ptr.7 ptr.6 query_bvaddr1_after_22_17= loop_4_count_after_3_4=2 loop_4_count_after_3_4=3 r1_after_22_17=4 pvalid.6 q___ptr_to_unsigned_char_v_after_7_4=3 query_load-word32mem_after r22_init query_bvandp___ptr_to_unsi.1 query_bvandr3_after_24_17=.1 query_bvandp___ptr_to_unsi r1_after_22_17=3 path_cond_to_22_17=2_ASM path_cond_to_25_17=1_ASM r14_init pvalid.3 path_cond_to_22_17=1_ASM r20_init pvalid.8 n_after_23_17=1 n_after_23_17=2 n_after_23_17=3 pvalid.4 pvalid.5 query_bvandptr_dst___ptr_t pvalid.7 r1_after_22_17=1 pvalid.1 r6_init r1_after_22_17=2 r25_init path_cond_to_24_17=3_ASM path_cond_to_25_17=2_ASM path_cond_to_12_4=4_C r23_init r3_init path_cond_to_12_4=3_C path_cond_to_13_4=1_C z_init rodata-witness-val ptr.9 c_after_26 ptr_dst___ptr_to_void_v_init path_cond_to_26_ASM path_cond_to_13_4=4_C r12_init z_after_26 ptr.1 path_cond_to_12_4=1_C n_init cond_at_17_17=2 cond_at_17_17=3 cond_at_17_17=0 cond_at_17_17=1 c_after_23_17=3 ptr.2 path_cond_to_22_17=4_ASM ptr.4 rodata-witness ret_init query_q___ptr_to_unsigned_.1 query_q___ptr_to_unsigned_ query_bvandr0_init_xffffff r26_init z_after_23_17=1 v_after_26 z_after_23_17=3 path_cond_to_24_17=4_ASM cond_at_5_4=3 v_after_23_17=1 c_init r5_init pvalid.2 cond_at_5_4=1 r12_after_22_17=4 r12_after_22_17=1 r12_after_22_17=2 r12_after_22_17=3 r2_after_33 query_bvaddr1_after_31_x00 query_load-word8mem_after_ p___ptr_to_unsigned_char_v_after_9_4=2 query_load-word8mem_initbv loop_4_count_after_6 cond_at_35_17=2 cond_at_35_17=3 r10_init cond_at_35_17=1 query_rodataMem_init cond_at_5_4=4 r8_init cond_at_5_4=2 r18_init query_ptr_src___ptr_to_voi r1_after_31 z_after_23_17=2 query_q___ptr_to_unsigned_.1 query_q___ptr_to_unsigned_ query_load-word8mem_after_.2 query_load-word8Mem_after_.1 query_load-word8mem_after_.1 query_bvaddr1_after_22_17=.2 query_bvaddr1_after_31_x00 query_bvandr3_after_24_17= query_load-word32Mem_initb query_bvandptr_dst___ptr_t query_bvaddr1_after_22_17=.1 query_load-word8mem_after_ query_rodataMem_init query_load-word32Mem_after query_bvandr3_after_24_17=.1 query_bvandr0_init_xffffff query_load-word8Mem_after_ query_load-word32mem_after.1 query_load-word8mem_initbv query_load-word32Mem_after.1 query_bvandp___ptr_to_unsi.1 query_load-word32mem_initb query_mem-eqmem_initMem_in query_bvaddr1_after_22_17= query_load-word32mem_after query_bvandp___ptr_to_unsi query_ptr_src___ptr_to_voi query_load-word8Mem_initpt))
